...
public class OrdersGUIController {
    ...
    public ObservableList<String> observableList; // ciudat nume
    ...
    private static double totalAmount; // not static?
    ...
    private void initData(){
        // var _menuData = service.getMenuData(); si o flosim pe asta
        ...
        placeOrder.setOnAction(event ->{ // functie separata (private)
            ...
            // se updateaza lista statica
            // referinta la KitchenGUIController
        ...
        payOrder.setOnAction(event -> {
            ...
            System.out.println("--------------------------");
            PaymentAlert pay = new PaymentAlert(service); // Pymaneytt alert trb mutat in controller
